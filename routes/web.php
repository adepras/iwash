...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/cancel_booking/{id}', [BookingController::class, 'cancelBooking'])->name('cancelBooking');
    Route::get('/failed_booking/{id}', [BookingController::class, 'failedBooking'])->name('failed_booking');
...
Route::middleware(['auth', 'admin'])->group(function () {
    ...
    Route::get('/bookings/download-csv', [BookingController::class, 'downloadCsv'])->name('bookings.downloadCsv');
